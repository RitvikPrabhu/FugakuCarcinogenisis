...
for NNODES in "${node_configs[@]}"; do
  ...
  for cancer in "${cancers[@]}"; do
    ...
    OUTPUT_DIR="/vol0004/ra000012/ritvik/FugakuCarcinogenisis/strong_scaling/8hit/${cancer}/${NNODES}_nodes_out"
...
llio_transfer /vol0004/ra000012/ritvik/FugakuCarcinogenisis/build/run_8hit
llio_transfer /vol0004/ra000012/ritvik/FugakuCarcinogenisis/data/${cancer}.txt

mpiexec /vol0004/ra000012/ritvik/FugakuCarcinogenisis/build/run_8hit \\
