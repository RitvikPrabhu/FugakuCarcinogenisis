...
for NNODES in "${node_configs[@]}"; do
  ...
  for cancer in "${cancers[@]}"; do
    ...
    OUTPUT_DIR="/vol0004/ra000012/ritvik/FugakuCarcinogenisis/runScripts/strong_scaling/7hit/${cancer}/${NNODES}_nodes_out"
...
llio_transfer /vol0004/ra000012/ritvik/FugakuCarcinogenisis/build/run_7hit
llio_transfer /vol0004/ra000012/ritvik/FugakuCarcinogenisis/data/${cancer}.txt

mpiexec /vol0004/ra000012/ritvik/FugakuCarcinogenisis/build/run_7hit \\
